const paths = {
  ...
  // Brand mark: a clothes hanger whose bar breaks into surf.
  logo: (
    <>
      <path d="M12 10.3V8.6a2.15 2.15 0 1 0-2.15-2.15" />
      <path d="M12 10.3 4.5 15.9h15z" />
      <path d="M5.2 19.5c1.13 1.15 2.27 1.15 3.4 0s2.27-1.15 3.4 0 2.27 1.15 3.4 0 2.27-1.15 3.4 0" />
    </>
  ),
  shell: (
    <>
      <path d="M12 20.6c-4.9-1.8-8.4-6.2-8.9-11.5a1.9 1.9 0 0 1 1.2-2 23.6 23.6 0 0 1 15.4 0 1.9 1.9 0 0 1 1.2 2c-.5 5.3-4 9.7-8.9 11.5Z" />
      <path d="M12 20.6V7.4M9.1 19.6 7.2 8M14.9 19.6 16.8 8" />
    </>
  ),
  users: (
    <>
      <circle cx="9" cy="8" r="3.6" />
      <path d="M2.5 20.5v-1.2a6.5 6.5 0 0 1 13 0v1.2M16.5 4.8a3.6 3.6 0 0 1 0 6.9m2.2 2.1a6.5 6.5 0 0 1 3.3 5.6v1.1" />
    </>
  ),
};
